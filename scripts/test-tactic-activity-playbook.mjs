...
const tacticsDb = await readJson('../src/knowledge_base/aiTransformation_tactics_database.json');
const playbookDb = await readJson('../src/knowledge_base/aiTransformation_tactic_activity_playbook.json');
const criteriaDb = await readJson('../src/knowledge_base/aiTransformation_criteria.json');
const antipatternDb = await readJson('../src/knowledge_base/aiTransformation_antipatterns.json');
