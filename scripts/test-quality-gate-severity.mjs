...
const dir = await mkdtemp(join(tmpdir(), 'aiTransformation-quality-gate-'));
...
const misclassifiedRealClaim = {
  claim: 'Agent tool fallback is manual.',
  classification: 'unsupported',
  source_location: 'diagnosis',
  failure_type: 'unsupported_org_claim',
...
const planningTacticHygieneClaim = {
  claim: 'Enforce agent behavioral boundaries [TAC-RISK-001].',
  classification: 'unsupported',
