...
import { AI_TACTICS_LOCAL, AI_VALIDATION_RULES } from '../knowledge_base';

const RULES = AI_VALIDATION_RULES as any;
...
export const validatePhase3Grounding = (strategyData: any, phase2: Phase2Validation, sourceText?: string): ValidationResult => {
  ...
  const validTacticIds = new Set(AI_TACTICS_LOCAL.map(t => t.id));
