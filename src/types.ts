...
export interface Phase2Validation {
  ...
  readiness_stage: 'Insufficient evidence' | 'Emerging' | 'Structured' | 'Scaling with friction' | 'Adaptive / Value-creating';
}
...
export type PersonaId = 'transformation_lead' | 'technology_lead' | 'service_owner';

export const PERSONA_IDS: PersonaId[] = ['transformation_lead', 'technology_lead', 'service_owner'];

export const PERSONA_LABELS: Record<PersonaId, string> = {
  transformation_lead: 'Transformation Lead',
  technology_lead: 'CIO / CTO / CDAO',
  service_owner: 'Business / Service Area Owner'
};
...
export interface AssessmentEvidenceSummary {
  ...
  headline: string;
  maturity_classification: Phase2Validation['readiness_stage'];
  key_metrics: string[];
